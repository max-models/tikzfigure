...
fig.draw([A, mid_BC], dashed=True, color="gray")
...
fig.draw(["top", "bot"], dashed=True, color="gray")
fig.draw(["left", "right"], dashed=True, color="gray")
...
fig.draw(["src.east", "corner", "dst.south"],
         arrows="->", thick=True, color="purple",
         segment_options=[
