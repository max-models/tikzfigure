...
(from [tutorial 5](tutorial_05_loops.qmd)) with math expressions for even more compact code:
...
- Combine expressions with [loops](tutorial_05_loops.qmd) for parametric grids
- Use expressions in [styling and transformations](tutorial_16_advanced_styling.qmd)
