...
define variables with `add_variable()` and want to use them in expressions:
...
You can pass expressions directly to `add_variable()`. This is powerful for
defining derived or computed values at compile time:
